...
var runningPortNumber = process.env.PORT || 1337 || process.env.OPENSHIFT_NODEJS_PORT ;
var domain = process.env.DOMAIN || 'http://localhost' || process.env.OPENSHIFT_NODEJS_IP ;
